...
class WalletViewModelTest {
    ...
    inner class EventTests {
        ...
        @Test
        @ExperimentalTime
        fun `state events is set`() = coroutinesTestExtension.runBlockingTest {
            // Given
            val events = listOf(
                Event(id = "1"),
                Event(id = "2"),
        ...
        @Test
        @ExperimentalTime
        fun `state tickets is set`() = coroutinesTestExtension.runBlockingTest {
            // Given
            val tickets = listOf(
                Ticket(id = 1),
                Ticket(id = 2),
        ...
        @Test
        @ExperimentalTime
        fun `state ticketsWithEvents is set`() = coroutinesTestExtension.runBlockingTest {
            // Given
            val tickets = listOf(
